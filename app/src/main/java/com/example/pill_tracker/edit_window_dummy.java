...
public class edit_window_dummy extends AppCompatActivity {
...
//                        Toast.makeText(MainActivity.this, "Add", Toast.LENGTH_LONG).show();
                        Intent myIntent = new Intent(edit_window_dummy.this, home2.class);
        ...
        myAdapter = new MyAdapter(edit_window_dummy.this, name, purpose, Dosage,numberOfPills, time);
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                        ...
                                        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                            ...
                                            Intent intent = new Intent(edit_window_dummy.this, edit_text_medicine.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.message:
                Intent i = new Intent(edit_window_dummy.this, mr_pillar.class);
...
//                this.startActivity(i1);
                return true;
            case R.id.home:
                Intent i2 = new Intent(edit_window_dummy.this, home2.class);
